 ...
 */
final class Version20230414135808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE reservation reservation VARCHAR(255) NOT NULL, CHANGE auth_entity auth_entity VARCHAR(255) DEFAULT NULL, CHANGE commande commande VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE commande commande VARCHAR(255) DEFAULT NULL, CHANGE reservation reservation BLOB DEFAULT NULL, CHANGE auth_entity auth_entity BLOB DEFAULT NULL');
