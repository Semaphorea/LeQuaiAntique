 ...
 */
final class Version20230315160032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void    
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(64) NOT NULL, prenom VARCHAR(64) NOT NULL, email VARCHAR(128) NOT NULL, nb_convive INT NOT NULL, commande VARCHAR(255) NOT NULL, intolerances_alimentaires LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, arrivee DATETIME NOT NULL, nombre_adultes INT NOT NULL,nombre_enfants INT NOT NULL, intolerance_alimentaire LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }  
