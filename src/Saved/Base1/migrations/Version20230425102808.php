 ...
 */
final class Version20230425102808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auth_entity ADD client VARCHAR(255) NOT NULL, ADD administrateur VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE passwordconfirmation passwordconfirmation TEXT DEFAULT NULL, ADD PRIMARY KEY (id)'); 
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auth_entity DROP client, DROP administrateur, CHANGE id id INT DEFAULT NULL, CHANGE roles roles VARCHAR(64) DEFAULT NULL, CHANGE email email VARCHAR(128) DEFAULT NULL, CHANGE password password VARCHAR(256) DEFAULT NULL, CHANGE passwordconfirmation passwordconfirmation VARCHAR(256) DEFAULT NULL');
