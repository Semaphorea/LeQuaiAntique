 ...
 */
final class Version20230419133701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE reservation reservation VARCHAR(255) NOT NULL, CHANGE auth_entity auth_entity VARCHAR(255) DEFAULT NULL, CHANGE commande commande VARCHAR(255) NOT NULL, ADD date_time_creation DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE reservation reservation BLOB DEFAULT NULL, CHANGE auth_entity auth_entity BLOB DEFAULT NULL,CHANGE commande commande VARCHAR(255) DEFAULT NULL, DROP date_time_creation DATETIME DEFAULT NULL,');
