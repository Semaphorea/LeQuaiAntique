 ...
 */
final class Version20230315160114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id), username VARCHAR(64) DEFAULT NULL, password VARCHAR(256) DEFAULT NULL, nom VARCHAR(64) DEFAULT NULL, prenom VARCHAR(64) DEFAULT NULL,auth_entity VARCHAR(255) NOT NULL, email VARCHAR(128) NOT NULL) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE formule (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(64) NOT NULL, description VARCHAR(255) NOT NULL, plats LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', prix DOUBLE PRECISION NOT NULL, date_application VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
